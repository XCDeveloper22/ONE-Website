      ...
      <AnimatePresence mode="wait">
        {showSplash ? (
          ...
          >
            ...
            {authError && (
              <div className="bg-red-500/10 border border-red-500/50 text-red-400 text-sm p-4 rounded-xl mb-6 text-left">
                {authError}
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-[#5865F2] hover:bg-[#4752C4] disabled:bg-[#4752C4] disabled:opacity-80 text-white font-medium py-3.5 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 group relative overflow-hidden"
            >
              <AnimatePresence mode="wait">
                {isLoggingIn ? (
                  <motion.div
